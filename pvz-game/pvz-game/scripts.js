...
zombies: [
                { type: 'normal', x: 0.10, y: 0.79, speed: 0.00020, direction: 1, frame: 0, animTimer: 0 },
                { type: 'cone', x: 0.02, y: 0.77, speed: 0.00020, direction: 1, frame: 0, animTimer: 0 }
            ],
            // mowers: [
            //     { x: -0.08, y: 0.82, speed: 0.0003, direction: 1 }
            // ],
            mowers: [
                { x: -0.03, y: 0.81, speed: 0.00025, direction: 1 }
            ],
            suns: [
